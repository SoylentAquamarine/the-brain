...
<!-- BRAIN_STATS_START -->
*Last updated: 2026-05-02 04:07 UTC — auto-generated by `update_readme_stats.py`*
...
|---|---|
| Total calls | 38 |
| Calls handled by free workers | 38 |
| Tokens offloaded from Claude | 14,547 |
| % of tokens saved | 100.0% |
| Estimated savings (Claude Sonnet rate) | $0.0436 |
...
|---|---|---|---|---|
| 2026-05-02 03:32 | **sambanova** | general | 1,853 | 3996ms |
...
<!-- BRAIN_HEALTH_START -->
*Last checked: 2026-05-02 04:07 UTC — updated hourly by automated health checks*

## Provider Health (Last 24h)

| Provider | Status | Uptime | Avg Latency | Samples |
|---|---|---|---|---|
| **cerebras** | ✅ | 100% | 300ms | 2 |
| **groq** | ✅ | 100% | 339ms | 4 |
| **cohere** | ✅ | 100% | 544ms | 4 |
| **sambanova** | ✅ | 100% | 696ms | 4 |
| **mistral** | ✅ | 100% | 765ms | 6 |
| **huggingface** | ✅ | 100% | 956ms | 6 |
| **pollinations** | ✅ | 100% | 1102ms | 2 |
| **fireworks** | ✅ | 100% | 1302ms | 6 |
| **openai** | ✅ | 100% | 1538ms | 6 |
| **gemini** | ⚠️ | 67% | 1553ms | 6 |
| **cloudflare** | ⚠️ | 67% | 6000ms | 6 |
| **ollama** | ⚠️ | 67% | 37033ms | 18 |
| **openrouter** | ❌ | 0% | 2102ms | 2 |
