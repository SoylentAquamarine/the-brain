...
<!-- BRAIN_STATS_START -->
*Last updated: 2026-04-25 03:37 UTC — auto-generated by `update_readme_stats.py`*

## Live Usage Stats

| Provider | Tier | Calls | Tokens | Avg Latency | Cost |
|---|---|---|---|---|---|
| **mistral** | FREE | 5 | 3,478 | 1826ms | free |
| **cerebras** | FREE | 12 | 1,987 | 323ms | free |
| **sambanova** | FREE | 1 | 1,251 | 5361ms | free |
| **gemini** | FREE | 3 | 1,108 | 1476ms | free |
| **groq** | FREE | 2 | 631 | 871ms | free |
| **openai** | FREE | 1 | 89 | 2780ms | $0.0000 |
...
|---|---|
| Total calls | 25 |
| Calls handled by free workers | 25 |
| Tokens offloaded from Claude | 8,544 |
| % of tokens saved | 100.0% |
| Estimated savings (Claude Sonnet rate) | $0.0256 |
...
<!-- BRAIN_HEALTH_START -->
*Last checked: 2026-04-25 03:37 UTC — updated hourly by automated health checks*
...
|---|---|---|---|---|
| **cohere** | ✅ | 100% | 234ms | 2 |
| **huggingface** | ✅ | 100% | 539ms | 3 |
| **pollinations** | ✅ | 100% | 595ms | 1 |
| **mistral** | ✅ | 100% | 791ms | 3 |
| **gemini** | ⚠️ | 67% | 357ms | 3 |
| **groq** | ⚠️ | 67% | 432ms | 3 |
| **openai** | ⚠️ | 67% | 1066ms | 3 |
| **cloudflare** | ⚠️ | 67% | 6094ms | 3 |
| **fireworks** | ❌ | 33% | 120ms | 3 |
| **cerebras** | ❌ | 33% | 126ms | 3 |
| **sambanova** | ❌ | 33% | 314ms | 3 |
| **openrouter** | ❌ | 0% | 552ms | 4 |
